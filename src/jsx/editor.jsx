...
function Editor({ text, setText, style, setStyle, currentDisplay }) {
  const englishLayout = [
    ['1','2','3','4','5','6','7','8','9','0'],
    ['Q','W','E','R','T','Y','U','I','O','P'],
    ['A','S','D','F','G','H','J','K','L'],
      ...
      <div className="keyboard-layout">
        ...
        <div className="keyboard-box right-box">
          ...
          <div className="buttons-grid">
            {layoutIndex<2 && (
              <>
                <FontButton style={style} setStyle={setStyle} historyChange={handleChange} currentDisplay={currentDisplay} />
                <ColorButton style={style} setStyle={setStyle} historyChange={handleChange} currentDisplay={currentDisplay} />
              </>
            )}
          </div>
          <div className="buttons-grid size-buttons-row">
            <SizeButtons style={style} setStyle={setStyle} historyChange={handleChange} currentDisplay={currentDisplay} />
          </div>
        </div>
